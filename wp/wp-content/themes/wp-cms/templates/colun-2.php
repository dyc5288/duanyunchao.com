...
<div class="wrapper" style="margin-top:5px;">
  <div id="feature" class="left">
     <div class="lh3">
      <div class="rh3">
        <div class="title"><span class="title_t left"><span class="title_t_i left">
          <h2><a href="/?cat=10" style="color:#FFF">生活</a></h2>
          </span></span>
          <div class="iterm right">
            <ul>
              <li><a href="/?cat=10"><span>更多...</span></a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="fcontent">
	  ...
	  <div class="portfolio">	
	   ...
	   <?php query_posts('showposts=3&cat=10'); while (have_posts()) : the_post(); ?>	   
							<div class="card">
							 <?php if ( get_post_meta($post->ID, 'pre_image', true) ) : ?>
					<?php $image = get_post_meta($post->ID, 'pre_image', true); ?>
						<div class="thumb" style="overflow: hidden;"><img width="200"  src="<?php echo $image; ?>" alt="<?php the_title() ?>" /></div>
				<?php else: ?>
						<div class="thumb" style="overflow: hidden;"><img width="200" src="<?php bloginfo('template_directory'); ?>/images/blank.jpg" /></div>
                   <?php endif; ?>
  ...
  <div id="icommend" class="right">
    <div class="lh3">
      <div class="rh3">
        <div class="title"><span class="title_t left"><span class="title_t_i left">
          <h2><a href="<?php echo get_settings('home'); ?>" style="color:#FFF">最新留言</a></h2>
          </span></span>
          <div class="iterm right">
            <ul>
...
<?php if ( $comments ) : foreach ($comments as $comment) : ?>
     ...
     <?php if ( !empty( $comment->comment_author_email ) ) { $md5 = md5( $comment->comment_author_email ); echo "<img class='home-grav' src='http://www.gravatar.com/avatar.php?gravatar_id=$md5&amp;size=60' alt='' />"; } ?>
            ...
            <dd>评论时间<font color="#FF9900"><?php comment_date('Y-m-d'); ?></font></dd>
          </dl>
