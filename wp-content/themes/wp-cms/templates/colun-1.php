 ...
 ?>
<!-- Begin colun1 -->
<?php if ($options['colun1']&& (
		($options['colun1_registered'] && $user_ID) || 
		($options['colun1_commentator'] && !$user_ID && isset($_COOKIE['comment_author_'.COOKIEHASH])) || 
		($options['colun1_visitor'] && !$user_ID && !isset($_COOKIE['comment_author_'.COOKIEHASH]))
	) ) : ?>
...
<div class="wrapper " style="margin-top:5px; margin-bottom:5px;">
    ...
    <div class="lh3">
      <div class="rh3">
        <div class="title"><span class="title_t left"><span class="title_t_i left">
          <h2><a href="/?cat=16" style="color:#FFF">PHP技术</a></h2>
          </span></span>
          <div class="iterm right">
            <ul>
              <li><a href="/?cat=16"><span>更多...</span></a></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="hotpost" class="left">
    <div class="lh3">
      <div class="rh3">
        <div class="title"><span class="title_t left"><span class="title_t_i left">
          <h2><a href="<?php echo get_settings('home'); ?>/" style="color:#FFF">互联网</a></h2>
          </span></span>
          <div class="iterm right">
            <ul>
              <li id="tab_t1" onmouseover="return ChangIterm(1)" class="thisiterm"><a href="#"><span>PHP</span></a></li>
              <li id="tab_t2" onmouseover="return ChangIterm(2)"><a href="#"><span>数据库</span></a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="fcontent">
      <div class="list-post clear" id="tab_1">
      <div class="showimg clear"><?php query_posts('showposts=1&cat=16'); while (have_posts()) : the_post(); ?>
	  <div style="overflow:hidden; width:130px; height:100px; float: left;">
      ...
      <div class="list-post clear" id="tab_2" style="display: none;">
     <div class="showimg clear"><?php query_posts('showposts=1&cat=17'); while (have_posts()) : the_post(); ?>
...
<ul style="padding-bottom: 3px;">
               <!--调取分类ID 6的(除最新一篇之外)最新10篇文章-->
	   <?php query_posts('showposts=3&cat=17'); while (have_posts()) : the_post(); ?>
  ...
  <div class="comfaq" class="right">
    <div class="lh3">
      <div class="rh3">
        <div class="title"><span class="title_t left"><span class="title_t_i left">
          <h2><a href="/?cat=17" style="color:#FFF">数据库技术</a></h2>
          </span></span>
          <div class="iterm right">
            <ul>
              <li><a href="/?cat=17"><span>更多...</span></a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="fcontent">
       <div class="list-post clear" style="padding-bottom:8px">
	  <ul>               <!--调取分类ID 6的(除最新一篇之外)最新10篇文章-->
	   <?php query_posts('showposts=9&cat=17'); while (have_posts()) : the_post(); ?>
