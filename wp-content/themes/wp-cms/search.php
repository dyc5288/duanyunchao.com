    ...
    <div class="lh3">
      <div class="rh3">
        <div class="title"><span class="title_t left"><span class="title_t_i left">
          <h2 class="wT1">搜索关键词：<?php echo $s; ?></h2>
          </span></span>
...
<div id="listcat2" class="clear">
  ...
  <?php if ( get_post_meta($post->ID, 'pre_image', true) ) : ?>
					...
					<div class="litimg">	<a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><img width="150" height="120" src="<?php echo $image; ?>" alt="<?php the_title() ?>" /></a></div>
				<?php else: ?>
						<div class="litimg"><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><img width="150" height="100" src="<?php bloginfo('template_directory'); ?>/images/blank.jpg" /></a></div>
                   <?php endif; ?>
