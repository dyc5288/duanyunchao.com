...
function comments_template( $file = '/comments.php', $separate_comments = false ) {
	global $wp_query, $withcomments, $post, $wpdb, $id, $post_id, $comment, $user_login, $user_ID, $user_identity, $overridden_cpage;
    $id = $post_id;
	...
	if ( $user_ID) {
		...
		$comments = get_comments( array('post_id' =>  $id, 'status' => 'approve', 'order' => 'DESC') );
	} else {
